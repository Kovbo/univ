...
function HeaderWrapper() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="menu-item me-lg-1">
            <Link className="menu-link py-3 active" to="/home">
              <span className="menu-title">Головна</span>
            </Link>
          </div>
          <div className="menu-item me-lg-1">
            <a className="menu-link py-3" href="/metronic8/react/demo2/builder">
                    ...
                    >
                      <div className="menu-item me-lg-1">
                        <a
                          ...
                          href="/metronic8/react/demo2/crafted/pages/profile/overview"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/profile/projects"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/profile/campaigns"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/profile/documents"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/profile/connections"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                  ...
                  >
                    ...
                    >
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/wizards/horizontal"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
                      ...
                      <div className="menu-item me-lg-1">
                        <a
                          className="menu-link py-3"
                          href="/metronic8/react/demo2/crafted/pages/wizards/vertical"
                        >
                          <span className="menu-bullet">
                            <span className="bullet bullet-dot" />
                          </span>
              ...
              >
                ...
                >
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/account/overview"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/account/settings"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              >
                ...
                >
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/error/404"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/error/500"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              >
                ...
                >
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/lists"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/statistics"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/charts"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/mixed"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/tables"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/crafted/widgets/feeds"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/apps/chat/private-chat"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/apps/chat/group-chat"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
                  ...
                  <div className="menu-item me-lg-1">
                    <a
                      className="menu-link py-3"
                      href="/metronic8/react/demo2/apps/chat/drawer-chat"
                    >
                      <span className="menu-bullet">
                        <span className="bullet bullet-dot" />
                      </span>
              ...
              <div className="menu-item me-lg-1">
                <a
                  className="menu-link py-3"
                  href="/metronic8/react/demo2/apps/user-management/users"
                >
                  <span className="menu-icon">
                    <span className="svg-icon svg-icon-2">
                      <svg
          ...
          <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            <div className="d-flex align-items-stretch" id="kt_header_nav">
              <div className="header-menu align-items-stretch">
                ...
                >
                  <div className="menu-item me-lg-1">
                    <Link className="menu-link py-3" to="/home">
                      <span className="menu-title">Головна</span>
                    </Link>
                  </div>
                  <div className="menu-item me-lg-1">
                    <Link className="menu-link py-3 active" to="/universities">
                ...
                <div className="topbar d-flex align-items-stretch flex-shrink-0">
                  <div className="d-flex align-items-center ms-1 ms-lg-3">
                    <a
                      ...
                      className="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px"
                    >
                      <span className="svg-icon theme-dark-hide svg-icon-2">
                        <svg
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
      ...
      bg="light"
      id="header"
      className="transparent align-items-stretch navbar-light"
    >
      <Container>
        <Navbar.Brand as={Link} to="/">
          <div className="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <img
              alt="Logo"
              src="https://preview.keenthemes.com/metronic8/react/demo2/media/logos/demo2-sticky.png"
